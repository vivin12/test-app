FROM default-image-registry.cloud/open-liberty:kernel-java8-openj9-ubi as staging
...
FROM default-image-registry.cloud/open-liberty:kernel-java8-openj9-ubi
